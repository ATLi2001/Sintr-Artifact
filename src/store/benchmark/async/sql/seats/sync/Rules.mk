...
OBJ-sync-sql-seats-transaction := $(LIB-store-frontend) $(o)seats_transaction.o

LIB-sync-sql-seats := $(OBJ-sync-sql-seats-transaction) $(LIB-sql-seats) $(o)delete_reservation.o \
