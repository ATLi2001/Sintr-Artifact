...
PROTOS += $(addprefix $(d), smallbank-proto.proto smallbank-validation-proto.proto)

LIB-smallbank := $(o)smallbank_transaction.o $(o)utils.o $(o)smallbank-proto.o $(o)smallbank_client.o $(o)bal.o $(o)write_check.o $(o)amalgamate.o $(o)transact.o $(o)deposit.o $(o)smallbank-validation-proto.o
